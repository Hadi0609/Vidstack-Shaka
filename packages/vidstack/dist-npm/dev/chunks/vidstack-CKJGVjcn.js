...
import { canOrientScreen, IS_IPHONE, isAudioSrc, canPlayAudioType, isVideoSrc, canPlayVideoType, isHLSSupported, isHLSSrc, isDASHSupported, isDASHSrc, isShakaSupported, IS_CHROME, IS_IOS, canGoogleCastSrc, canChangeVolume } from './vidstack-vIAU-deh.js';
import { TimeRange, getTimeRangesEnd, getTimeRangesStart, updateTimeIntervals } from './vidstack-BFg1ZqiG.js';
import { isTrackCaptionKind, TextTrackSymbol, TextTrack } from './vidstack-ABsPNAYn.js';
...
import { preconnect, getRequestCredentials } from './vidstack-WPqG_DWb.js';
...
class ShakaProviderLoader extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import('../providers/vidstack-shaka.js')).ShakaProvider(this.target, context);
  }
}
  ...
  async requestGoogleCast(trigger) {
    try {
      ...
      if (!this.#googleCastLoader) {
        const $module = await import('./vidstack-DbdnlLx_.js');
