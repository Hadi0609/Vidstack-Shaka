import { DOMEvent, EventsTarget, ViewController, SetRequired, MaybeStopEffect, InferEventDetail, WriteSignal, ReadSignalRecord, Context, Scope, Dispose, Store, State, Writable, Component, ReadSignal } from './vidstack-BOvzfZjK.js';
...
interface ShakaPlayer {
     ...
     */
    getAudioLanguagesAndRoles(): ShakaLanguageRole[];
    /**
     ...
     */
    getTextLanguagesAndRoles(): ShakaLanguageRole[];
    /**
 ...
 * ```
 */
type ShakaRequestFilter = (type: ShakaRequestType, request: ShakaRequest) => Promise<void> | void;
/**
 ...
 * ```
 */
type ShakaResponseFilter = (type: ShakaRequestType, response: ShakaResponse) => Promise<void> | void;
/**
 ...
 */
interface ShakaErrorEvent extends ShakaEvent {
    type: 'error';
    /** The error details. */
    detail: ShakaError;
}
 ...
 */
interface ShakaBufferingEvent extends ShakaEvent {
    type: 'buffering';
 ...
 */
interface ShakaAdaptationEvent extends ShakaEvent {
    type: 'adaptation';
 ...
 */
interface ShakaTracksChangedEvent extends ShakaEvent {
    type: 'trackschanged';
}
/**
 * Variant changed event.
 */
interface ShakaVariantChangedEvent extends ShakaEvent {
    type: 'variantchanged';
}
/**
 * Text track changed event.
 */
interface ShakaTextChangedEvent extends ShakaEvent {
    type: 'textchanged';
}
/**
 * Text track visibility changed event.
 */
interface ShakaTextTrackVisibilityEvent extends ShakaEvent {
    type: 'texttrackvisibility';
}
/**
 * Content loaded event.
 */
interface ShakaLoadedEvent extends ShakaEvent {
    type: 'loaded';
}
/**
 * Content unloading event.
 */
interface ShakaUnloadingEvent extends ShakaEvent {
    type: 'unloading';
}
/**
 * The Shaka Player constructor.
 */
interface ShakaConstructor {
 ...
 */
type ShakaConstructorLoader = () => Promise<{
 ...
 * ```
 */
type ShakaLibrary = ShakaNamespace | ShakaConstructorLoader | string | undefined;
/**
 ...
 * ```
 */
type ShakaInstanceCallback = (player: ShakaPlayer) => void;
/**
...
interface ShakaMediaEvent<DetailType = unknown> extends DOMEvent<DetailType> {
    target: MediaPlayer;
}
/**
 * Fired when the browser begins downloading the Shaka Player library.
 */
interface ShakaLibLoadStartEvent extends ShakaMediaEvent<void> {
}
/**
 ...
 * @detail constructor
 */
interface ShakaLibLoadedEvent extends ShakaMediaEvent<ShakaConstructor> {
}
/**
 ...
 * @detail error
 */
interface ShakaLibLoadErrorEvent extends ShakaMediaEvent<Error> {
}
/**
 ...
 * @detail instance
 */
interface ShakaInstanceEvent extends ShakaMediaEvent<ShakaPlayer> {
}
/**
 ...
 */
interface ShakaUnsupportedEvent extends ShakaMediaEvent<void> {
}
/**
 ...
 * @detail error
 */
interface ShakaPlayerErrorEvent extends ShakaMediaEvent<ShakaError> {
}
/**
 ...
 * @detail data
 */
interface ShakaPlayerBufferingEvent extends ShakaMediaEvent<ShakaBufferingEvent> {
}
/**
 * Fired when Shaka Player starts loading a manifest.
 */
interface ShakaLoadingEvent extends ShakaMediaEvent<void> {
}
/**
 ...
 * @detail data
 */
interface ShakaPlayerLoadedEvent extends ShakaMediaEvent<ShakaLoadedEvent> {
}
/**
 ...
 * @detail data
 */
interface ShakaPlayerUnloadingEvent extends ShakaMediaEvent<ShakaUnloadingEvent> {
}
/**
 ...
 * @detail data
 */
interface ShakaPlayerAdaptationEvent extends ShakaMediaEvent<ShakaAdaptationEvent> {
}
/**
 ...
 * @detail data
 */
interface ShakaPlayerTracksChangedEvent extends ShakaMediaEvent<ShakaTracksChangedEvent> {
}
/**
 ...
 * @detail data
 */
interface ShakaPlayerVariantChangedEvent extends ShakaMediaEvent<ShakaVariantChangedEvent> {
}
/**
 ...
 * @detail data
 */
interface ShakaPlayerTextChangedEvent extends ShakaMediaEvent<ShakaTextChangedEvent> {
}
/**
 ...
 * @detail data
 */
interface ShakaPlayerTextTrackVisibilityEvent extends ShakaMediaEvent<ShakaTextTrackVisibilityEvent> {
}
/**
 * Fired when streaming begins in Shaka Player.
 */
interface ShakaStreamingEvent extends ShakaMediaEvent<void> {
}
/**
 * Fired when the manifest has been parsed by Shaka Player.
 */
interface ShakaManifestParsedEvent extends ShakaMediaEvent<void> {
}
...
interface MediaPlayerEvents extends MediaEvents, MediaRequestEvents, MediaUserEvents, LoggerEvents, VideoPresentationEvents, HLSProviderEvents, DASHProviderEvents, ShakaProviderEvents, GoogleCastEvents {
 ...
 * ```
 */
declare class ShakaProvider extends VideoProvider implements MediaProviderAdapter {
    #private;
    protected $$PROVIDER_TYPE: string;
    /**
     * The Shaka Player constructor.
     */
    get ctor(): ShakaConstructor | null;
    /**
     ...
     * ```
     */
    get library(): ShakaLibrary;
    set library(library: ShakaLibrary);
    preconnect(): void;
    setup(): void;
    loadSource(src: Src, preload?: HTMLMediaElement['preload']): Promise<void>;
    /**
