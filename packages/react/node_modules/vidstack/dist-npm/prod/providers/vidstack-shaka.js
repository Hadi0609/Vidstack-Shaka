import { loadScript, preconnect } from '../chunks/vidstack-Dk__mjCL.js';
import { IS_CHROME, isShakaSupported } from '../chunks/vidstack-BJQe-Bv2.js';
import { VideoProvider } from './vidstack-video.js';
import { isUndefined, isString, DOMEvent, isFunction, listenEvent, effect, camelToKebabCase, peek } from '../chunks/vidstack-BGSTndAW.js';
import { coerceToError } from '../chunks/vidstack-C9vIqaYT.js';
import { QualitySymbol } from '../chunks/vidstack-B01xzxC4.js';
import { TextTrack, TextTrackSymbol } from '../chunks/vidstack-hux_9F1C.js';
...
import '../chunks/vidstack-BsvN8ZAj.js';
...
async function importShaka(loader, callbacks = {}) {
  ...
  try {
    ...
    throw Error(
      false ? "[vidstack] failed importing Shaka Player. Dynamic import returned invalid object." : ""
    );
  } catch (err) {
...
async function loadShakaScript(src, callbacks = {}) {
  ...
  try {
    ...
    if (!shaka || !isFunction(shaka.Player)) {
      throw Error(
        false ? "[vidstack] failed loading Shaka Player. Could not find a valid `shaka.Player` constructor on window" : ""
      );
    }
...
class ShakaProvider extends VideoProvider {
  ...
  #library = `${JS_DELIVR_CDN}/npm/shaka-player@4.15.1/dist/shaka-player.compiled${".js"}`;
  /**
