...
import { canOrientScreen, IS_IPHONE, isAudioSrc, canPlayAudioType, isVideoSrc, canPlayVideoType, isHLSSupported, isHLSSrc, isDASHSupported, isDASHSrc, isShakaSupported, IS_CHROME, IS_IOS, canGoogleCastSrc, canChangeVolume } from './vidstack-BJQe-Bv2.js';
import { TimeRange, getTimeRangesEnd, getTimeRangesStart, updateTimeIntervals } from './vidstack-ChQTHmIQ.js';
import { isTrackCaptionKind, TextTrackSymbol, TextTrack } from './vidstack-hux_9F1C.js';
...
import { preconnect, getRequestCredentials } from './vidstack-Dk__mjCL.js';
  ...
  async requestGoogleCast(trigger) {
    try {
      ...
      if (!this.#googleCastLoader) {
        const $module = await import('./vidstack-BLecOaue.js');
