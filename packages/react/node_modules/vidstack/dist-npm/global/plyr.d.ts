...
declare class Plyr implements PlyrProps, PlyrMethods {
    ...
    loop: boolean;
    poster: string;
    get type(): "" | "audio" | "video" | "google-cast" | "dash" | "hls" | "shaka" | "vimeo" | "youtube";
    get isHTML5(): boolean;
    get isEmbed(): boolean;
    get buffered(): number;
    get stopped(): boolean;
