import { createComputation, read, SCOPE, write, isFunction$1 as isFunction, onDispose, update, dispose, setContext, getScope, getContext, isUndefined, scoped, createScope, isFunction as isFunction$1, setAttribute, setStyle, root, DOMEvent, untrack, noop, listenEvent } from './maverick-3G6tTwt0.js';
...
class Instance {
  ...
  #attachAttrs() {
    ...
    for (const name of Object.keys(this.attrs)) {
      if (isFunction$1(this.attrs[name])) {
  ...
  #attachStyles() {
    ...
    for (const name of Object.keys(this.styles)) {
      if (isFunction$1(this.styles[name])) {
...
export { Instance, METHODS, ON_DISPATCH, PROPS, ViewController, computed, createComponent, createContext, effect, effect$1, hasProvidedContext, isReadSignal, isWriteSignal, provideContext, readonly, signal, useContext };
