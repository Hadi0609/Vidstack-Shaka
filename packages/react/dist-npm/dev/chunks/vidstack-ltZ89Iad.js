...
import { IS_CHROME, canGoogleCastSrc, IS_IOS, IS_SERVER, loadScript } from './vidstack-BGIjDt_e.js';
...
class GoogleCastLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-C01f_b5s.js')).GoogleCastProvider(this.#player, ctx);
  }
