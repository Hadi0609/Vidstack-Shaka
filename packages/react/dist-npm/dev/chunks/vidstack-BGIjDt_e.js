...
function isShakaProvider(provider) {
...
class AudioProviderLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-BkLh7s5K.js')).AudioProvider(this.target, ctx);
  }
}
...
class HLSProviderLoader extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import('./vidstack-D8OKqlLM.js')).HLSProvider(this.target, context);
  }
}
...
class ShakaProviderLoader extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import('./vidstack-BPxQChj2.js')).ShakaProvider(this.target, context);
  }
}
...
class VimeoProviderLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-B10K9M-F.js')).VimeoProvider(this.target, ctx);
  }
...
class YouTubeProviderLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-D-YzlsjJ.js')).YouTubeProvider(this.target, ctx);
  }
  async loadPoster(src, ctx, abort) {
  ...
  async requestGoogleCast(trigger) {
    try {
      ...
      if (!this.#googleCastLoader) {
        const $module = await import('./vidstack-ltZ89Iad.js').then(function (n) { return n.loader; });
...
class SourceSelection {
  ...
  constructor(domSources, media, loader, customLoaders = []) {
    ...
    this.#media = media;
    this.#loader = loader;
    const DASH_LOADER = new DASHProviderLoader(), HLS_LOADER = new HLSProviderLoader(), SHAKA_LOADER = new ShakaProviderLoader(), VIDEO_LOADER = new VideoProviderLoader(), AUDIO_LOADER = new AudioProviderLoader(), YOUTUBE_LOADER = new YouTubeProviderLoader(), VIMEO_LOADER = new VimeoProviderLoader(), EMBED_LOADERS = [YOUTUBE_LOADER, VIMEO_LOADER];
