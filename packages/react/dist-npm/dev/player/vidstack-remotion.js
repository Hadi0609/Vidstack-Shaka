...
import { IS_SERVER, useMediaState, isRemotionSrc, Primitive, useSliderState } from '../chunks/vidstack-BGIjDt_e.js';
export { isRemotionProvider } from '../chunks/vidstack-BGIjDt_e.js';
...
class RemotionProviderLoader {
  ...
  async load(ctx) {
    return new (await import('../chunks/vidstack-Cqzrylvv.js')).RemotionProvider(this.target, ctx);
  }
}
