...
import { IS_SERVER, useMediaState, isRemotionSrc, Primitive, useSliderState } from '../chunks/vidstack-rsASKGit.js';
export { isRemotionProvider } from '../chunks/vidstack-rsASKGit.js';
...
class RemotionProviderLoader {
  ...
  async load(ctx) {
    return new (await import('../chunks/vidstack-CUHVLhLr.js')).RemotionProvider(this.target, ctx);
  }
}
