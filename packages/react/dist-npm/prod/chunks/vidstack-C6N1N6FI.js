...
import { IS_CHROME, canGoogleCastSrc, IS_IOS, IS_SERVER, loadScript } from './vidstack-rsASKGit.js';
...
class GoogleCastLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-BmJX0wgj.js')).GoogleCastProvider(this.#player, ctx);
  }
