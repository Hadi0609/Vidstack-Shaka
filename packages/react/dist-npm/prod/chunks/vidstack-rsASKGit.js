...
class AudioProviderLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-BRTyBrpw.js')).AudioProvider(this.target, ctx);
  }
}
...
class HLSProviderLoader extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import('./vidstack-DUwJGKbu.js')).HLSProvider(this.target, context);
  }
}
...
class ShakaProviderLoader extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import('./vidstack-BkllN19h.js')).ShakaProvider(this.target, context);
  }
}
...
class VimeoProviderLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-B8bFXGl6.js')).VimeoProvider(this.target, ctx);
  }
...
class YouTubeProviderLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-D7-_-9LB.js')).YouTubeProvider(this.target, ctx);
  }
  async loadPoster(src, ctx, abort) {
  ...
  async requestGoogleCast(trigger) {
    try {
      ...
      if (!this.#googleCastLoader) {
        const $module = await import('./vidstack-C6N1N6FI.js').then(function (n) { return n.loader; });
